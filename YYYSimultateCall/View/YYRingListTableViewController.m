//
//  YYRingListTableViewController.m
//  YYYSimultateCall
//
...
#import "YYRingListTableViewController.h"
#import "YYController.h"

@interface YYRingListTableViewController ()
{
    NSArray *_ringList;
...
@implementation YYRingListTableViewController

- (id)initWithCoder:(NSCoder *)decoder
{
    self = [super initWithCoder:decoder];
    if (self) {
        _ringList = @[@"seaside",@"opening",@"nohappiness",@"luck",@"duola"];
        _selectedRow = 0;
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [_ringList objectAtIndex:index];
